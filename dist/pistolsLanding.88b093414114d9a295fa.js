...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   addFilterByFeature: () => (/* binding */ addFilterByFeature),\n/* harmony export */   filterByFeature: () => (/* binding */ filterByFeature),\n/* harmony export */   resetFilterByFeature: () => (/* binding */ resetFilterByFeature)\n/* harmony export */ });\nvar pistolFilters = {\n  es: [{\n    label: \"Mecha\",\n    value: \"matchlock\"\n  }, {\n    label: \"Rueda\",\n    value: \"wheellock\"\n  }, {\n    label: \"Pedernal\",\n    value: \"flintlock\"\n  }, {\n    label: \"Percusión\",\n    value: \"percussion\"\n  }],\n  en: [{\n    label: \"Matchlock\",\n    value: \"matchlock\"\n  }, {\n    label: \"Wheellock\",\n    value: \"wheellock\"\n  }, {\n    label: \"Flintlock\",\n    value: \"flintlock\"\n  }, {\n    label: \"Percussion\",\n    value: \"percussion\"\n  }]\n};\nvar artilleryFilters = {\n  es: [{\n    label: \"Campo\",\n    value: \"field\"\n  }, {\n    label: \"Naval\",\n    value: \"navy\"\n  }, {\n    label: \"Mortero\",\n    value: \"mortar\"\n  }],\n  en: [{\n    label: \"Field\",\n    value: \"field\"\n  }, {\n    label: \"Navy\",\n    value: \"navy\"\n  }, {\n    label: \"Mortar\",\n    value: \"mortar\"\n  }]\n};\nvar totalItems = {\n  es: \" productos\",\n  en: \" products\"\n};\nvar showProduct = function showProduct(product) {\n  product.classList.remove('filtered');\n  product.removeAttribute('hidden');\n};\nvar resetFilterByFeature = function resetFilterByFeature(productList) {\n  var inputs = document.querySelectorAll('#options input[type=\"radio\"]');\n  inputs.forEach(function (input) {\n    return input.checked = false;\n  });\n  productList.forEach(function (product) {\n    showProduct(product);\n  });\n  amountRendering();\n};\nvar amountRendering = function amountRendering() {\n  var quantityProd = document.querySelector('#productQuatity');\n  quantityProd.innerHTML = \"<span>\".concat(document.querySelectorAll('.aaog-product-wrapper:not(.filtered)').length, \"</span> \").concat(totalItems[document.querySelector('html').lang]);\n};\nvar addFilterByFeature = function addFilterByFeature(pageName) {\n  var filters;\n  switch (pageName) {\n    case 'pistolsandrifles':\n      filters = pistolFilters;\n      break;\n    case 'artillery':\n      filters = artilleryFilters;\n      break;\n    default:\n      break;\n  }\n  var dataToDisplay = filters[document.querySelector('html').lang];\n  var target = document.querySelector('#options');\n  var fragment = document.createDocumentFragment();\n  dataToDisplay.forEach(function (filter) {\n    var label = document.createElement('label');\n    label.setAttribute('for', filter.value);\n    label.textContent = filter.label;\n    var input = document.createElement('input');\n    input.type = 'radio';\n    input.classList.add('aaog-visuallyhidden');\n    input.id = filter.value;\n    input.value = filter.value;\n    input.name = pageName;\n    var wrapper = document.createElement('div');\n    wrapper.classList.add('aaog-input-wrapper');\n    wrapper.appendChild(input);\n    wrapper.appendChild(label);\n    fragment.appendChild(wrapper);\n  });\n  target.appendChild(fragment);\n  amountRendering();\n};\nvar filterByFeature = function filterByFeature(type, listOfProducts) {\n  listOfProducts.forEach(function (product) {\n    if (product.dataset.feature !== type) {\n      product.classList.add('filtered');\n      product.addEventListener('transitionend', function () {\n        product.setAttribute('hidden', true);\n      });\n    } else {\n      showProduct(product);\n    }\n  });\n  amountRendering();\n};\n\n//# sourceURL=webpack://AAOG/./js/filters.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../styles/styles.css */ \"./styles/styles.css\");\n/* harmony import */ var _styles_products_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../styles/products.css */ \"./styles/products.css\");\n/* harmony import */ var _styles_contact_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../styles/contact.css */ \"./styles/contact.css\");\n/* harmony import */ var _styles_productLanding_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../styles/productLanding.css */ \"./styles/productLanding.css\");\n/* harmony import */ var _shared__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./shared */ \"./js/shared.js\");\n/* harmony import */ var _filters__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./filters */ \"./js/filters.js\");\n\n\n\n\n\n\n(0,_shared__WEBPACK_IMPORTED_MODULE_4__.Shared)();\n(0,_filters__WEBPACK_IMPORTED_MODULE_5__.addFilterByFeature)('pistolsandrifles');\nvar productList = document.querySelectorAll('.aaog-product-wrapper');\nvar featureTrigger = document.querySelectorAll('input[type=\"radio\"]');\nvar resetTrigger = document.querySelector('#resetTrigger');\nvar filter = document.querySelector('#filterTrigger');\nvar filterValue;\nresetTrigger.addEventListener('click', function () {\n  (0,_filters__WEBPACK_IMPORTED_MODULE_5__.resetFilterByFeature)(productList);\n  filterValue = null;\n}, false);\nfeatureTrigger.forEach(function (feature) {\n  feature.addEventListener('change', function (e) {\n    return filterValue = e.target.value;\n  }, false);\n});\nfilter.addEventListener('click', function () {\n  if (filterValue) {\n    (0,_filters__WEBPACK_IMPORTED_MODULE_5__.filterByFeature)(filterValue, productList);\n  }\n}, false);\n\n//# sourceURL=webpack://AAOG/./js/pistolsLanding.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack://AAOG/./styles/contact.css?");

/***/ }),

/***/ "./styles/productLanding.css":
/*!***********************************!*\
  !*** ./styles/productLanding.css ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack://AAOG/./styles/productLanding.css?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./js/pistolsLanding.js");
/******/ 	
/******/ })()
;